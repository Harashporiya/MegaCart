...
export default function ToolsPage() {
    const [toolsItem, setToolsItem] = useState<ToolsItem[]>([]);
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const tools = response.data.items.filter(
                    (item: ToolsItem) => item.category === 'Tools'
                );
                ...
                setError("Failed to fetch tools items");
                setLoading(false);
            }
        };
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="text-sm text-gray-500">Number Of Item: {item.numberOfItem}</span>
